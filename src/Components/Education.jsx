        ...
        <div className="education">
            ...
            <div className="flex my-6 xl:flex-row flex-col justify-center ">
                <div className="poppins_font w-4/5 mx-auto px-10 my-6 text-gray-300">
                    <h2 className="text-green-500 text-2xl underline mb-3 flex"> <img src="/mortarboard.png" alt="Education" className="h-10 w-10 rounded-full bg-white mr-2" /> Saylani Mass IT Training</h2>
                ...
                <div className="poppins_font w-4/5 mx-auto px-10 my-6 text-gray-300">
                    <h2 className="text-green-500 text-2xl underline mb-3 flex"> <img src="/mortarboard.png" alt="Education" className="h-10 w-10 rounded-full bg-white mr-2" /> Intermediate</h2>
                ...
                <div className="poppins_font w-4/5 mx-auto px-10 my-6 text-gray-300">
                    <h2 className="text-green-500 text-2xl underline mb-3 flex"> <img src="/mortarboard.png" alt="Education" className="h-10 w-10 rounded-full bg-white mr-2" /> Matriculation</h2>
